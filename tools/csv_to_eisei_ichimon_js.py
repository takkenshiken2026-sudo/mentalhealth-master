...
- category: tools/csv_to_exam_site_master.py の CATEGORY_TO_FIELD と揃える
"""
...
OUT_JS_GENERIC = ROOT / "exam-site-data-ichimon.js"
...
def main() -> int:
    ...
    OUT_JS_GENERIC.write_text(js, encoding="utf-8")
